...
public class ProductInfoPage {
	...
	private By quantitiy = By.id("input-quantity");
	...
	//This method will collect product Meta Data and pricing data in the form of HashMap.
	//THis method will return product Info Map
	...
	public void selectQuantity(String qty){
		elementUtil.doSendKeys(quantitiy, qty);
	}
